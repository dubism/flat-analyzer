    ...
    <div className="flex h-screen min-h-0 flex-col bg-stone-100 text-stone-900 dark:bg-stone-950 dark:text-stone-100">
      <header className="safe-top flex items-center justify-between gap-3 border-b border-stone-200 bg-white px-3 py-3 dark:border-stone-800 dark:bg-stone-900 md:px-5">
        ...
        <div className="flex flex-shrink-0 flex-wrap items-center justify-end gap-2">
          ...
          <a href="#/analyzer" className="inline-flex min-h-10 items-center gap-1 rounded-xl px-2 text-sm font-semibold text-blue-700 underline decoration-blue-300 underline-offset-4 hover:text-blue-900 hover:decoration-blue-600 dark:text-blue-300 dark:decoration-blue-500 dark:hover:text-blue-200">Analyzátor <span aria-hidden="true">→</span></a>
